const menu = [
  ...
  },
  {
    ...
    desc: `En çok sevilen çorbalardan biridir o! Bu yüzden zamansız çorbadır.`,
  }
];
...
function addMenu(view) {
  menuDOM.innerHTML = "";
  for (let item in view) {
    let menuItem = document.createElement("div");
    menuItem.classList.add("menu-items", "col-lg-6", "col-sm-12");
    menuItem.innerHTML = `<img src="${view[item].img}" alt="${view[item].title}" class="photo">
    <div class="menu-info">
      <div class="menu-title">
        <h4>${view[item].title}</h4>
        <h4 class="price">${view[item].price}</h4>
      </div>
      <div class="menu-text">
      ${view[item].desc}
      </div>
